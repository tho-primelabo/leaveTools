...
// Tax
define('LMS_HEALTH_INSURANCE', 1.5);
define('LMS_SOCIAL_INSURANCE', 8);
define('LMS_UNEMPLOYMENT_INSURANCE', 1);
define('LMS_TAX_PERSON',9000000);
define('LMS_TAX_REDUCE_FAMILY',3600000);