...
$route['contracttypes/delete/(:num)'] = 'contracttypes/delete/$1';
$route['contracttypes/edit/(:num)'] = 'contracttypes/edit/$1';
$route['contracttypes/index'] = 'contracttypes/index';
$route['contracttypes/create'] = 'contracttypes/create';
$route['contracttypes/export'] = 'contracttypes/export';
$route['contracttypes'] = 'contracttypes';
...
$route['timesheet/loadData'] = 'timesheet/loadData';
$route['timesheet/update'] = 'timesheet/update';
$route['timesheet/insert'] = 'timesheet/insert';
$route['timesheet/delete'] = 'timesheet/delete';
$route['timesheet/getActivities'] = 'activity/getActivities';
