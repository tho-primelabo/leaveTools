...
<h2><?php echo lang('rooms_index_title');?> &nbsp;<?php echo $help;?></h2>
    ...
    <tr>
        <td data-order="<?php echo $room['id']; ?>">
            ...
            <div class="pull-right">
                <a href="#" class="confirm-delete" data-id="<?php echo $room['id'];?>" title="<?php echo lang('rooms_index_thead_tip_delete');?>"><i class="mdi mdi-delete nolink"></i></a>&nbsp; 
                <a href="<?php echo base_url();?>rooms/edit/<?php echo $room['id']; ?>" title="<?php echo lang('rooms_index_thead_tip_edit');?>"><i class="mdi mdi-pencil nolink"></i></a>
            </div>
        </td>
...
<div class="row-fluid">
    <div class="span12">
      ...
      <a href="<?php echo base_url();?>rooms/create" class="btn btn-primary"><i class="mdi mdi-plus-circle"></i>&nbsp;<?php echo lang('rooms_index_button_create');?></a>
    </div>
</div>
...
<div id="frmDeletePosition" class="modal hide fade">
    ...
    <div class="modal-footer">
        <a href="#" id="lnkDeletePosition" class="btn btn-danger"><?php echo lang('rooms_index_popup_button_yes');?></a>
        <a href="#" onclick="$('#frmDeletePosition').modal('hide');" class="btn"><?php echo lang('rooms_index_popup_button_no');?></a>
    </div>
</div>
