...
<div class="row-fluid">
    <div class="span12">
        ...
        <div class="span2">
            <h2><input type="checkbox" id="weekend" checked class="span1">Weekend</input></h2>
        </div>
        <div class="row-fluid">
            <div class="span12">
            ...
            <div id="modalBody" class="modal-body">
                <h4 id="modalTitle" class="modal-title"></h4>
                 <div class="control-group">
                    <label class="control-label" for="inputProject">Project:</label>
                    <div class="controls">
                        <select name="eproject" id="eproject" class="selectPro"></select>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="inputActivity">Activity:</label>
                    <div class="controls">
                        <select name="eactivity" id="eactivity" class="selectAct"></select>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="when">Hours:</label>
