...
<thead>
    <tr>
      ...
      <th><?php echo lang('leavetypes_type_thead_description');?></th>
    </tr>
  </thead>
  <tbody>
  <?php foreach ($contracttypes as $type) { ?>
    <tr>
      ...
      <td>
          <a href="<?php echo base_url();?>contracttypes/edit/<?php echo $type['id'] ?>" data-target="#frmEditLeaveType" data-toggle="modal" title="<?php echo lang('leavetypes_type_thead_tip_edit');?>"><i class="mdi mdi-pencil nolink"></i></a>
...
<div class="row-fluid">
    <div class="span12">
        <a href="<?php echo base_url();?>contracttypes/export" class="btn btn-primary"><i class="mdi mdi-download"></i>&nbsp; <?php echo lang('leavetypes_type_button_export');?></a>
        &nbsp;
        <a href="<?php echo base_url();?>contracttypes/create" class="btn btn-primary" data-target="#frmAddLeaveType" data-toggle="modal"><i class="mdi mdi-plus-circle"></i>&nbsp; <?php echo lang('leavetypes_type_button_create');?></a>
    </div>
</div>
