        ...
        <div class="span6">
            <div class="row-fluid">
                <div>
                    ...
                    <?php } else { ?>
                    <input type="text" name="duration" id="duration" value="<?php echo $leave['duration']; ?>" required />
                    <?php } ?>
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/lms/leave.edit-1.0.js" type="text/javascript"></script>
