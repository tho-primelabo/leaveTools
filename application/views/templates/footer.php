    ...
    <div class="row" id="footer">
        ...
        <div class="span4 pull-right">
              <?php switch ($language_code){
                  case 'fr' : echo '<a class="anchor" href="http://primelabo.com.vn/" target="_blank">PrimeLabo</a>'; break;
                  default : echo '<a class="anchor" href="http://primelabo.com.vn/" target="_blank">PrimeLabo</a>'; break;
              } ?>
          &nbsp;Copy Right 2019
        </div>
    </div>
